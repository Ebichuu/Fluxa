...
- Torra 首次下载成功只表示已有可看版本；当前版本进入 Emby 成为追更洗版基准后才开始观察，达到版本控制目标或观察结束后才结束。
...
- 订阅设置：来源、定时、Torra 追更洗版时间表和 MoviePilot 独立开关；不混入系统连接设置。
...
- Torra 追更洗版使用独立开关，默认关闭；默认相对 Emby 基准就绪的计划为 `2 / 6 / 12 / 24 / 48 / 72 小时`，允许自定义。
