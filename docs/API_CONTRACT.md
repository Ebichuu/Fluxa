...
新增能力使用真正的 URL 版本契约：`docs/contracts/http-api-contract-v2.json`，当前共 35 条。v1 的 47 条冻结路径和历史状态码不变。
...
当前 47 条 v1 契约不承担新增语义。35 条 `/api/v2` 接口包括：
...
## 11. 已实现的 Torra 追更洗版接口

以下接口已在 2026-07-18 阶段 6 注册，并计入当前 35 条机器契约：
...
以下接口已经进入 35 条 v2 机器契约和当前 React：
