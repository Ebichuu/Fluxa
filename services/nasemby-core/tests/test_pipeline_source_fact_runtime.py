...
class PipelineSourceFactRuntimeTests(unittest.TestCase):
    ...
    def test_active_torra_is_completed_when_downstream_confirms_target_handoff(self):
        facts = build_pipeline_source_facts(context(
            torra={
                "id": "torra-private-1",
                "completed": False,
    ...
    def test_active_torra_stays_active_without_successful_downstream_evidence(self):
        facts = build_pipeline_source_facts(context(
            torra={
                "id": "torra-private-1",
                "completed": False,
        ...
        self.assertEqual(torra["state"], "active")
        self.assertEqual(torra["reasonCode"], "TORRA_ACQUISITION_ACTIVE")
