...
class SourceContractTest(IsolatedActivityLogMixin, unittest.TestCase):
    ...
    def test_background_runtime_starts_each_scheduler_once(self):
        ...
        self.assertEqual(
            ...
            ["hdhive-checkin", "discover-cache-preload", "torra-subscription-sync", "candidate-source", "home-summary-refresh", "subscription-workbench-refresh", "calendar-snapshot-refresh"],
        )
